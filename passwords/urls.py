...
PasswordCreateView, PasswordUpdateView, PasswordDeleteView, PasswordRegenerateView)
...
urlpatterns = [
    ...
    path('<int:pk>/regenerate/', PasswordRegenerateView.as_view(), name='password_regenerate'),
